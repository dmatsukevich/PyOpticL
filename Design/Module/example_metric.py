...
# To use 
layout.metric=True     # Select 25mm grid instead of inch
optomech.metric = True # Select metric bolts to mount optics to baseplate
...
# x-y coordinates of mount holes (if layout.metric is True, this is in 25mm steps)
...
# Same code as in example_baseplate.py 
